...
namespace Gerenciador.Servico.WCF
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            app.UseServiceModel(builder =>
            {
                ...
                //builder.ConfigureServiceHostBase<Servico.Servico>(CustomUserNamePasswordValidatorCore.AddToHost);
                ...
                ConfigureSoapService<Servico.Servico, Servico.IServico>(nameof(Servico.Servico));
            });
        }
    }
}
